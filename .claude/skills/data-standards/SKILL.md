...
1. **What a "schema" is, here.** One or two sentences: a schema is the structure of a
   ...
   means checking a table definition or migration script against Rumi's own rules for how
...
here too. Verified end-to-end against a real Slack channel, and with a deliberately-broken channel
override to confirm the exit code never moves either way.
