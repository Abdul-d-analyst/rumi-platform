-- Same as migrations_base, plus a compliant addition: a new column with a
-- declared PII sensitivity classification (see the accompanying contract
-- in the test itself) and a new nullable column with a wider type — both
-- should PASS.
